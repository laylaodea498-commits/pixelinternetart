        ...
        <div className="space-y-6">
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="mt-6">
                ...
                <div className="mt-2 flex rounded-md shadow-sm">
                  ...
                  <button 
                    onClick={() => {
                      navigator.clipboard.writeText(`https://pixelwall.com/ref/${mockUser.referral_code}`);
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <h4 className="text-sm font-medium text-gray-500 uppercase tracking-wider mb-3">Share Your Profile</h4>
                <div className="flex space-x-2">
                  <button className="flex-1 bg-[#1DA1F2] text-white py-2 rounded-md text-xs font-bold hover:opacity-90 transition">X (Twitter)</button>
                  <button className="flex-1 bg-[#E1306C] text-white py-2 rounded-md text-xs font-bold hover:opacity-90 transition">Instagram</button>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white overflow-hidden shadow rounded-lg border border-gray-200">
            <div className="px-4 py-5 sm:px-6 border-b border-gray-200 bg-gray-50">
              <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">Referral Stats</h3>
            </div>
            <div className="px-4 py-5 sm:p-6 grid grid-cols-2 gap-4">
              <div>
                <p className="text-xs text-gray-500 uppercase">Clicks</p>
                <p className="text-xl font-bold text-gray-900">{mockUser.referral_stats?.clicks}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase">Signups</p>
                <p className="text-xl font-bold text-gray-900">{mockUser.referral_stats?.signups}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase">Conversions</p>
                <p className="text-xl font-bold text-indigo-600">{mockUser.referral_stats?.conversions}</p>
              </div>
              <div>
                <p className="text-xs text-gray-500 uppercase">Earned</p>
                <p className="text-xl font-bold text-green-600">£{mockUser.referral_stats?.total_earned.toFixed(2)}</p>
              </div>
            </div>
          </div>
        </div>
